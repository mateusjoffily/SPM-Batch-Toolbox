...
data.preproc(1).fdir{1}='./s3/run1';
data.preproc(1).fdir{2}='./s3/run2';
data.preproc(1).fdir{3}='./s3/run3';
% Directory where 3D image is saved
data.preproc(1).sdir='./s3/3d';
...
data.model(1).fdir{1}='./s3/run1';
data.model(1).fdir{2}='./s3/run2';
data.model(1).fdir{3}='./s3/run3';
% Logfiles: .mat files containing 'names', 'onsets' and 'durations' cells
% See SPM5 documentation for 'Multiple Conditions'
data.model(1).log{1}='./s3/log/run1.mat';
data.model(1).log{2}='./s3/log/run2.mat';
data.model(1).log{3}='./s3/log/run3.mat';
% SPM.mat directory
data.model(1).mdir='./s3/model1a';
...
%-----------------------------------------------------------------------
% Functional images directories
data.model(2).fdir{1}='./s3/run1';
% Logfiles: .mat files containing 'names', 'onsets' and 'durations' cells
% See SPM5 documentation for 'Multiple Conditions'
data.model(2).log{1}='./s3/log/run1.mat';
% SPM.mat directory
data.model(2).mdir='./s3/model1b';
% Contrast files: .mat files containing user defined contrasts.
% See SPM5 'Contrast Manager' documentation for more information
data.model(2).con='';
...
%-----------------------------------------------------------------------
% Functional images directories
data.model(3).fdir{1}='./s3/run2';
% Logfiles: .mat files containing 'names', 'onsets' and 'durations' cells
% See SPM5 documentation for 'Multiple Conditions'
data.model(3).log{1}='./s3/log/run2.mat';
% SPM.mat directory
data.model(3).mdir='./s3/model1c';
% Contrast files: .mat files containing user defined contrasts.
% See SPM5 'Contrast Manager' documentation for more information
data.model(3).con='';
...
%-----------------------------------------------------------------------
% Functional images directories
data.model(4).fdir{1}='./s3/run3';
% Logfiles: .mat files containing 'names', 'onsets' and 'durations' cells
% See SPM5 documentation for 'Multiple Conditions'
data.model(4).log{1}='./s3/log/run3.mat';
% SPM.mat directory
data.model(4).mdir='./s3/model1d';
% Contrast files: .mat files containing user defined contrasts.
% See SPM5 'Contrast Manager' documentation for more information
data.model(4).con='';
...
data.util(1).idir{1}='./s3/run1';
data.util(2).idir{1}='./s3/run2';
data.util(3).idir{1}='./s3/run3';
